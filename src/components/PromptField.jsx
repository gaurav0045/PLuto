...
const PromptField = () => {
  ...
  const handleInputChange = useCallback(() => {
    const value = inputField.current.innerText.trim();
    setPlaceholderShown(value.length === 0);
  ...
  const handlePaste = useCallback(
    (e) => {
      ...
      document.execCommand('insertText', false, pasteText); // Preserves formatting
      handleInputChange();
      moveCursorToEnd();
    },
  ...
  return (
    ...
    >
      ...
      <IconBtn
        ...
        classes="ms-auto"
        variants={PromptFieldChildrenVariant}
        onClick={handleSubmit} // Added handler
      />
